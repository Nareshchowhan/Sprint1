...
//For posting company details
	...
	@PostMapping(path="/api/v1/company")
	...
	@GetMapping(path="/api/getCompanyById/{companyId}")
	...
	@PutMapping(path="/api/updateCompanyById/{companyId}")
	...
	@DeleteMapping(path="/api/deleteCompanyById/{companyId}")
