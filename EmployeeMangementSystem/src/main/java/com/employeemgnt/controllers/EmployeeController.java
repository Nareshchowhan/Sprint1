...
public class EmployeeController {
	...
	//For posting Employee details
		...
		@GetMapping(path="/api/allemployee")
		...
		@PutMapping(path="/api/updateEmployee/{employeeId}")
		...
		@DeleteMapping(path="/api/deleteEmployeeById/{employeeId}")
		...
		//Deleting all employee details
			@DeleteMapping(path="/api/deleteAllEmployeedetails")
